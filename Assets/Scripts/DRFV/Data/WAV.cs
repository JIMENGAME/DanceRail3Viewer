...
namespace DRFV.Data
{
    public class WAV
    {
        ...
        public AudioClip ToAudioClip(string clipName = "")
        {
            AudioClip audioClip = AudioClip.Create(clipName, SampleCount, ChannelCount, Frequency, false);
            audioClip.SetData(ChannelCount == 2 ? StereoChannel : LeftChannel, 0);
            return audioClip;
        }
    }
}