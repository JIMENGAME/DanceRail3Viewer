...
namespace DRFV.Story
{
    public class StoryContentManager : MonoBehaviour
    {
        ...
        public void UnlockByPlaySong()
        {
            ...
            storyChallengeContainer.tapSize = currentSettings.TapSize;
            storyChallengeContainer.freeFlickSize = currentSettings.FreeFlickSize;
            storyChallengeContainer.flickSize = currentSettings.FlickSize;
            storyChallengeContainer.tapAlpha = currentSettings.TapAlpha;
            storyChallengeContainer.flickAlpha = currentSettings.FlickAlpha;
            storyChallengeContainer.freeFlickAlpha = currentSettings.FreeFlickAlpha;
            storyChallengeContainer.GameEffectParamEQLevel = currentSettings.GameEffectParamEQLevel;
            storyChallengeContainer.GameEffectGaterLevel = currentSettings.GameEffectGaterLevel;
            storyChallengeContainer.GameEffectTap = currentSettings.GameEffectTap;
            storyChallengeContainer.playerGameComboDisplay = (GameComboDisplay)currentSettings.ComboDisp;
            storyChallengeContainer.gameSubJudgeDisplay = (GameSubJudgeDisplay)currentSettings.SmallJudgeDisp;
            storyChallengeContainer.FCAPIndicator = currentSettings.FCAPIndicator;
